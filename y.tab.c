...
{
       0,     0,     3,     5,     8,    10,    12,    13,    17,    19,
      20,    24,    26,    28,    33,    38,    45,    49,    58
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      13,     0,    -1,    14,    -1,    14,    13,    -1,    19,    -1,
      11,    -1,    -1,    11,    16,    15,    -1,    19,    -1,    -1,
      19,    18,    17,    -1,     3,    -1,    11,    -1,     5,     4,
      19,     6,    -1,     5,     7,    19,     6,    -1,     5,     9,
      19,    19,    19,     6,    -1,     5,     8,     6,    -1,     5,
      10,     5,    11,    15,     6,    19,     6,    -1,     5,    11,
      17,     6,    -1
};
...
{
       0,   127,   127,   129,   133,   150,   154,   154,   160,   164,
     164,   170,   178,   186,   195,   204,   215,   222,   258
};
#endif
...
{
  "$end", "error", "$undefined", "NUMBER", "INC", "OPENPAR", "CLOSEPAR",
  "DEC", "HALT", "IFZ", "DEFINE", "ID", "$accept", "statements",
  "statement", "lists", "$@1", "exprs", "$@2", "expr", 0
};
#endif
...
{
       0,    11,     0,    12,     0,     2,     4,     0,     0,     0,
       0,     0,     0,     1,     3,     0,     0,    16,     0,     0,
       0,     9,    13,    14,     0,     0,    18,     0,     0,     5,
       0,    10,    15,     0,     0,     7,     0,    17
};
...
{
      -1,    -8,     5,    -8,     6,    -1,    -8,    -1,    -1,     1,
      -1,     3,    -1,    -8,    -8,    12,    13,    -8,    -1,    10,
      16,    17,    -8,    -8,    -1,    14,    -8,    -1,    18,    15,
      22,    -8,    -8,    14,    -1,    -8,    23,    -8
};
...
{
      15,    16,     1,    18,     2,    21,    13,    17,    19,     7,
       3,    24,     8,     9,    10,    11,    12,    28,    22,    23,
      21,    25,    26,    -8,    32,    29,    -6,    36,    34,    37,
      14,    35,     0,     0,    31
};

static const yytype_int8 yycheck[] =
{
       7,     8,     3,    10,     5,    12,     0,     6,     5,     4,
      11,    18,     7,     8,     9,    10,    11,    24,     6,     6,
      27,    11,     6,     6,     6,    11,    11,    34,     6,     6,
       5,    33,    -1,    -1,    27
};
...
{
       0,     3,     5,    11,    13,    14,    19,     4,     7,     8,
       9,    10,    11,     0,    13,    19,    19,     6,    19,     5,
      17,    19,     6,     6,    19,    11,     6,    18,    19,    11,
      15,    17,     6,    16,     6,    15,    19,     6
};
...
#line 134 "fiz.y"
    {
	err_value = 0;
	resolve((yyvsp[(1) - (1)].node_val), NULL);
	if (err_value == 0) {
		int num = eval((yyvsp[(1) - (1)].node_val), NULL);
		if (num != -1) {
			printf ("%d\n", num);
		}
	}
...
#line 150 "fiz.y"
    {
	ids[numIDs++] = (yyvsp[(1) - (1)].string_val);
 }
    break;
...
#line 160 "fiz.y"
    {
	nodes[nodeCount++] = (yyvsp[(1) - (1)].node_val);
 }
    break;
...
#line 179 "fiz.y"
    {
		struct TREE_NODE * node = (struct TREE_NODE *) malloc(sizeof(struct TREE_NODE));
		node -> type = ID_NODE;
		node -> idValue = (yyvsp[(1) - (1)].string_val);
		(yyval.node_val) = node;
  }
    break;
...
#line 187 "fiz.y"
    {   
		struct TREE_NODE *node = (struct TREE_NODE *) malloc(sizeof(struct TREE_NODE));
		node-> type = INC_NODE;
		node-> args[0] = (yyvsp[(3) - (4)].node_val);
		node -> nArgs = 1;
		(yyval.node_val) = node;   
	}
    break;
...
#line 205 "fiz.y"
    {
    		struct TREE_NODE *node = (struct TREE_NODE *) malloc(sizeof(struct TREE_NODE));
		node-> type = IFZ_NODE;
		node-> args[0] = (yyvsp[(3) - (6)].node_val);
		node-> args[1] = (yyvsp[(4) - (6)].node_val);
		node-> args[2] = (yyvsp[(5) - (6)].node_val);
		node -> nArgs = 3;
		(yyval.node_val) = node;
	}
    break;
...
#line 223 "fiz.y"
    {
		...
		struct FUNC_DECL *f = find_function((yyvsp[(4) - (8)].string_val));
		if (f == NULL) {
		...
		//expr
		f-> definition = (yyvsp[(7) - (8)].node_val);
		f->resolved = 0;
		node->func = f;
...
#line 259 "fiz.y"
    {
		struct TREE_NODE *node = (struct TREE_NODE *) malloc(sizeof(struct TREE_NODE));
		node-> type = CALL_NODE;
		node-> idValue = (yyvsp[(2) - (4)].string_val);

		struct FUNC_DECL *f = find_function((yyvsp[(2) - (4)].string_val));
		if (f != NULL) {
			node->nArgs = f->numArg;
		} else {
